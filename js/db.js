...
const SEED_VERSION = 14; // Bump this to force re-seed
...
async function seedDatabase() {
  ...
  const itineraryItems = [
    ...
    { dayIndex: 1, placeId: null, sortOrder: 2, customName: '🏨 Check in Hilton Tokyo, Shinjuku', timeSlot: 'morning', startTime: '10:30', notes: 'Drop bags at Hilton Tokyo (6-6-2 Nishi-Shinjuku). Early bag storage, room likely ready by 15:00.', status: 'planned' },
    ...
    { dayIndex: 1, placeId: 'r1', sortOrder: 5, customName: '', timeSlot: 'evening', startTime: '18:00', notes: 'Ichiran in Shibuya — first ramen in Japan! 10min train back to Hilton.', status: 'planned' },
    { dayIndex: 1, placeId: null, sortOrder: 6, customName: '🚶 Walk to Hilton (10min from Shinjuku Stn)', timeSlot: 'evening', startTime: '19:30', notes: 'Early night — recover from red-eye. Explore Hilton area, grab drinks at hotel bar.', status: 'planned' },
    ...
    { dayIndex: 2, placeId: 'r8', sortOrder: 1, customName: '', timeSlot: 'afternoon', startTime: '13:00', notes: 'Gyukatsu beef cutlet lunch in Shibuya — cook it yourself on hot stone!', status: 'planned' },
    ...
    { dayIndex: 2, placeId: 'r2', sortOrder: 4, customName: '', timeSlot: 'evening', startTime: '19:30', notes: 'Fuunji tsukemen near Shinjuku Station — walking distance to Hilton!', status: 'planned' },

    // Day 3 — Tue Mar 17: Akihabara + Ikebukuro [BASE: HILTON SHINJUKU]
    { dayIndex: 3, placeId: 'a6', sortOrder: 0, customName: '', timeSlot: 'morning', startTime: '10:00', notes: 'MUST DO! Geek paradise — arcades, retro game shops, Yodobashi Camera. ~20min from Shinjuku.', status: 'planned' },
    ...
    { dayIndex: 3, placeId: 'a7', sortOrder: 3, customName: '', timeSlot: 'afternoon', startTime: '16:30', notes: 'Pokemon Center Mega Tokyo in Ikebukuro — 15min from Shinjuku on JR.', status: 'planned' },
    { dayIndex: 3, placeId: 'r12', sortOrder: 4, customName: '', timeSlot: 'evening', startTime: '18:30', notes: 'Omoide Yokocho — tiny yakitori bars literally 5min walk from Hilton!', status: 'planned' },
    ...
    { dayIndex: 6, placeId: 'a3', sortOrder: 0, customName: '', timeSlot: 'morning', startTime: '09:30', notes: 'Imperial Palace East Gardens — beautiful in March. Cherry blossoms may be starting!', status: 'planned' },
    { dayIndex: 6, placeId: 'a17', sortOrder: 1, customName: '', timeSlot: 'morning', startTime: '11:00', notes: 'Shinjuku Gyoen — THE cherry blossom spot. Mid-March = early blooms. Japanese + English + French gardens.', status: 'planned' },
    ...
    { dayIndex: 7, placeId: null, sortOrder: 1, customName: '🛒 Last-minute shopping at Tokyo Station', timeSlot: 'afternoon', startTime: '13:00', notes: 'Tokyo Station underground: Character Street, Ramen Street, souvenir shops. Easy access from Fairmont.', status: 'planned' },
